  ...
  return (
    <div className="flex flex-col gap-4 h-full">
      ...
      <div
        ...
        className={`
          ...
          ${dragging
            ...
            : "border-zinc-800 hover:border-zinc-700 bg-zinc-900 hover:bg-zinc-800"
          }
        `}
      >
        <input
      ...
      <textarea
        ...
        className="flex-1 min-h-[160px] bg-zinc-900 border border-zinc-800 rounded-xl px-3 py-2.5 text-sm text-white placeholder-zinc-700 focus:outline-none focus:border-zinc-600 resize-none font-mono text-xs leading-relaxed"
      />
      ...
      <button
        onClick={loadSample}
        disabled={loading}
        className="text-xs text-zinc-500 hover:text-zinc-300 transition-colors py-1 border border-zinc-800 rounded-lg hover:border-zinc-700"
      >
